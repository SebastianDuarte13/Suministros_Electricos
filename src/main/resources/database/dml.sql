...
-- Inserta datos en la tabla direccioncliente
INSERT INTO direccioncliente (direccion) VALUES
('Carrera 7 # 123, Bogotá'),
('Avenida 19 # 456, Medellín');
...
INSERT INTO clientes (nombre_cliente, apellido_cliente, email_cliente, telefono_cliente, id_direccioncliente) VALUES
('Samuel', 'Orpina', 'samuel.orpina@example.com', 3123456789, 1),
('Valeria', 'Ortiz', 'valeria.ortiz@example.com', 3134567890, 2);
...
(1, 1, 'Compra de Cables', 'Compra de cables de energía', 100, 200000),
(2, 2, 'Compra de Interruptores', 'Compra de interruptores de luz', 50, 40000);
...
(1, 1, 10, 2000000, 0, 2000000),
(2, 2, 5, 200000, 0, 200000);
